...
const columns = (blockexplorerURL) => [
        
    {
        ...
        render: (text, record) => {
            ...
            const timeString12Hr = newDate.toLocaleTimeString('en-US',{timeZone:'UTC',hour12:true,hour:'numeric',minute:'numeric'})
            const day = newDate.toLocaleString('en-US', {day: 'numeric', month: 'short'})
            return (
                <>
                <p style={{fontSize:"2em", margin:"0"}}>{text}</p>
                <div style={{fontSize:"1.3em", margin:"0"}}>{day}, {timeString12Hr}</div>
                </>
            )
        }
    },
    ...
    },
    {
        ...
        render: (text, record) => {
            if (record.category === ('erc20' || 'ethTransfer') ) {
                return(
                    <img alt="" src="https://res.cloudinary.com/dl4murstw/image/upload/v1668495917/user_1_vd4ki1.png" width="40" />)
            } else {
                return(<img alt="" src="https://res.cloudinary.com/dl4murstw/image/upload/v1668495918/scroll_bkmays.png" width="40" />)
            }
        }
    },
    {
            ...
            if (record.flow === 'Receive') {
                ...
                if (transfers[0]) {
                    ...
                    return (
                        <div style={{fontSize:"1.3em"}}>
                            <div>To</div>
                            <div><a href={blockexplorerURL + 'address/' + record.to} target="_blank" rel="noopener noreferrer">{truncateEthAddress(String(record.to))}</a></div>
                        </div>
                    )
                }
    ...
    },
    {
        ...
        render: (text, record) => {
            if (record.flow === 'Receive') {
                return (<img alt="" src="https://res.cloudinary.com/dl4murstw/image/upload/v1668599379/right-arrow_1_owfvzh.png" width="60"/>)
            } else if (record.flow === 'Send') {
                return (<img alt="" src="https://res.cloudinary.com/dl4murstw/image/upload/v1668599379/left-arrow_kxwpcx.png" width="60"/>)
            } else if (record.flow === 'Exchange') {
                return (<img alt="" src="https://res.cloudinary.com/dl4murstw/image/upload/v1668492843/right-left_uom8y3.png" width="60"/>)
            } else {
                return (<img alt="" src="https://res.cloudinary.com/dl4murstw/image/upload/v1668599379/left-arrow_kxwpcx.png" width="60"/>)
            }
        }
            ...
            if (record.category === 'erc20') {
                if (record.logEvents[0]?.logo && record.logEvents[0].param_value && record.logEvents[0].contractDecimals) {
                    ...
                    return (
                        <div style={{display:"flex"}}>
                            <img alt="" src={record.logEvents[0].logo} height="50"/>
                            <div style={{fontSize:"1.2em", marginLeft:"3px"}}>{symbol}{(record.logEvents[0].param_tokenId)}<div>{record.logEvents[0].ticker}</div></div>
                        </div>
                    )
                }
                ...
                return (
                    <div style={{display:"flex"}}>
                        <img alt="" src="https://res.cloudinary.com/dl4murstw/image/upload/v1668503933/0x0000000000000000000000000000000000000000_oinhk2.png" height="50"/>
                ...
                if (transfers[1]?.logo && transfers[1].param_value && transfers[1].contractDecimals) {
                    ...
                    return <a href={blockexplorerURL + 'tx/' + record.txnHash} target="_blank" rel="noopener noreferrer"><img src="https://res.cloudinary.com/dl4murstw/image/upload/v1668603364/link_ykhdal.png" height="50"/> Learn more</a>
                }
            } else {
                return <a href={blockexplorerURL + 'tx/' + record.txnHash} target="_blank" rel="noopener noreferrer"><img src="https://res.cloudinary.com/dl4murstw/image/upload/v1668603364/link_ykhdal.png" height="50"/> Learn more</a>
            }
    ...
    },
    {
        ...
        render: (text, record) => {
            ...
            return (
                <>
                    <p>{gasFee.toFixed(6)} ETH <img alt="" src="https://res.cloudinary.com/dl4murstw/image/upload/v1668511869/gas-station_ydpfe5.png" height="12" /></p>
                    <p>(${gasFeeQuote})</p>
                </>
            )
        }
